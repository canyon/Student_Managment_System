...
<head runat="server">
    ...
    <style type="text/css">
        * {
        ...
        body {
            height: 100%;
            background: #fff url(style/images/ElCapitan.jpg) 50% 50% no-repeat;
    ...
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <div style="text-align: center;">
                ...
                <%--Width="320px"--%>
                <asp:GridView ID="GridView4" runat="server" AllowPaging="true" OnPageIndexChanging="GridView4_PageIndexChanging">
                    <PagerTemplate>
                        当前第:
                                <%--//((GridView)Container.NamingContainer)就是为了得到当前的控件--%>
                        <asp:Label ID="LabelCurrentPage" runat="server" Text="<%# ((GridView)Container.NamingContainer).PageIndex + 1 %>"></asp:Label>
