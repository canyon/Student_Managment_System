<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="teacher.aspx.cs" Inherits="Student_Managment_System.teacher" %>
    ...
    <head runat="server">
        ...
        <style type="text/css">
            * {
            ...
            body {
                height: 100%;
                background: #fff url(style/images/Yosemite4.jpg) 50% 50% no-repeat;
    ...
    <body>
        <form id="form1" runat="server">
            ...
            <div>
                ...
                <br />
                <div style="text-align: center;">
                    <asp:Button ID="Button1" runat="server" Text="查询全部" OnClick="Button1_Click" /> 选择查询年份：
                    ...
                    课程名：
                    <asp:TextBox ID="TextBox1" runat="server" placeholder="输入课程名"></asp:TextBox>
